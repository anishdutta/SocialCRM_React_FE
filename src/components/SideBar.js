...
function SideBar() {
  return (
    <div className="sidebar vw-100 sticky-top top-0 d-flex">
      <Link to="/" className="text-decoration-none text-center m-auto">
        <h5 className="text-uppercase text-decoration-none text-center m-auto px-2">
          Social crm
        </h5>
      </Link>
      <ul className="list-unstyled col text-sidebar d-flex m-auto flex-row justify-content-between">
