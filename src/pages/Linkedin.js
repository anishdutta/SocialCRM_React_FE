...
// import LatestComment from "../components/Posts//LinkedinLatestComment";
...
function Post() {
  ...
  useEffect(() => {
    ...
    //     // window.location.reload();
    //     if (err) {
    //       localStorage.removeItem("liaccesstoken");
    //       localStorage.removeItem("lipageid");
    //       localStorage.removeItem("liuserid");
    //     }
    //   });
  }, []);
  ...
  return !accessid ? (
    <div className="h-100 d-flex align-items-center justify-content-center">
      <LiLogin setisLoggedin={setisLoggedin} />
    </div>
  ) : (
    <>
      {/* {updated && ( */}
